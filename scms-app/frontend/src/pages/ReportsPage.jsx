...
const sections = [
  {
    key: "suppliers",
    label: "Suppliers",
    cols: ["Code", "Name", "Phone", "Email"],
    keys: ["supplier_code", "supplier_name", "telephone", "email"],
  },
  {
    key: "shipments",
    label: "Shipments",
    cols: ["Number", "Date", "Status", "Destination", "Supplier"],
    keys: ["shipment_number", "shipment_date", "shipment_status", "destination", "supplier_code"],
  },
  {
    key: "deliveries",
    label: "Deliveries",
    cols: ["Code", "Date", "Qty", "Status", "Shipment"],
    keys: ["delivery_code", "delivery_date", "quantity_delivered", "delivery_status", "shipment_number"],
  },
];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted text-sm">Daily, weekly, and monthly supplier, shipment, and delivery reports</p>
      </div>
